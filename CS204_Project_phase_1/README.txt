...
4)A new window will appear that will have sections to show Register details(number and data),Data Memory, a section having basic code with their respective PC and machine code.   It has two buttons, STEP and RUN. You can check your RISC-V code stepwise by pressing STEP. On the other hand, the RUN button will execute your entire  
